...
const Dashboard = () => {
  ...
  const filteredProcesses = selectedArea === "Todas"
  ? processes
  : processes.filter((process) => process.area?.nome === selectedArea);
        ...
        <div className="container mx-auto mt-6 p-6">
          ...
          <div className="space-y-4">
            {filteredProcesses.map((process) => (
              ...
              >
                <h3 className="text-lg font-bold">Processo: {process.nome}</h3>
          ...
          <div className="mt-8">
            ...
            <ProcessFlow processes={filteredProcesses} />
            </div>

          <div className="mt-8">
            <h2 className="text-xl font-semibold mb-4">Distribuição dos Processos</h2>
            <ProcessChart processes={filteredProcesses} />
            </div>
        </div>
      </div>
    </div>
